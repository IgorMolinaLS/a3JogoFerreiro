...
public class Table {
    ...
    public static final String FACETEXT = "src/imagens/table.png";

    public Table(int filtro, int wrap, int modo) {
        this.filtro = filtro;
        this.wrap = wrap;
        this.modo = modo;
    ...
    public void generateTable(GL2 gl) {
        gl.glPushMatrix();

        // Carregar a textura uma vez, fora do loop de faces
        textura.setAutomatica(false);
        textura.gerarTextura(gl, FACETEXT, 0);  // Carregar a textura apenas uma vez
